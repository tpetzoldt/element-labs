...
The project is related to the lab exercise
...
Communication can be done in person or in the [Matrix](https://matrix.org)[^Matrix] chat group. 
The idea of the chat group is that all (= "the community") can learn from each other. Private
...
possible to create separate communication channels in 
[OPAL](https://tud.de/opal)[^OPAL]
or in the Matrix for your group.
...
You will have four weeks time for the preparation of the report. Then upload it as 
PDF od HTML document and (optionally) an .R or Quarto (.qmd) script to the
**File** folder of your group in the OPAL learning management system. 
