...
by solving a system of linear equations, iterative numerical optimization needs to be used instead. 
...
a globally optimal solution can be found.
...
and $K$ (carrying capacity). This is the function after which the $r$ and $K$ strategists are
named in ecology.
