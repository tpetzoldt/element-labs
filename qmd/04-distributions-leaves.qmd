...
The experimental hypotheses is, that the sampling strategy has an
...
variance. The result is to be visualized with bar charts and box
plots. We use the **leave width** as an example, an analysis of the
other variables is left as an optional exercise.
...
The two samples where collected with different sampling strategies:
...
**Alternative:** The mean width (and possibly also the variance) differ because of more subjective sampling of HSE students.
