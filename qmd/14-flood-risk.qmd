...
Here, it is described how to fit distributions to a given hydrollogical data set. 
...
Let’s repeat the procedure for a Lognormal distribution of three parameters. In this case the package
