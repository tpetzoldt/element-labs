...
(source: German Weather Service, DWD [https://www.dwd.de](https://www.dwd.de)) and
...
**Formatting and style:** The page limit is 3-5 pages (plus references and an optional title page), font size should be 11 or 12 points, line spacing 1.1-1.3 lines, reasonable page margins (at least 2cm). The outline should stricly follow an IMRaD (Introduction, Methods, Results and Discussion) structure. As the report is short and quite methodological, Methods and Results can be merged, but we expect a separate Discussion. Figures and tables should be numbered and have a caption. Short code can be part of the text, longer code segments and purely technical tables should be avoided. The report can be written with any text processing software (e.g. Quarto or Word).

**Submission date:** 2026-01-24 to allow feedback before the examination period. 
